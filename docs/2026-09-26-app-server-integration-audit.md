...
- Carpetas, asignación de recetas, favoritos, etiquetas personales, preferencias de presentación y lista de compra viven en almacenamiento local por UUID. El servidor solo guarda la biblioteca y etiquetas culinarias del contenido; no hay API/tablas de sincronización de organización personal. No se comparten entre dispositivos ni tras reinstalar. Es un límite funcional pendiente si se espera sincronización cloud.
